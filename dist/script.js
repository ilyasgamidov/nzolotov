...
window.addEventListener('DOMContentLoaded', () => {
  ...
  tabs('.price-fotoAndVideo__tabs', '.price-fotoAndVideo__tabs-item', '.price-fotoAndVideo__table', 'active', 'flex'); // tabs('.main-tabs', '.main-tabs-item', '.main-content-item', 'active');
  ...
  try {
    const modals = () => {
      ...
      bindModal('.order', '.modal-order', '.modal-order-content .close'); // showModalByTime('.popup-consultation', 5000);
    };
  ...
  const forms = () => {
    ...
    form.forEach(item => {
      item.addEventListener('submit', e => {
        ...
        postData('mailer/smart.php', formData).then(res => {
          console.log(res);
